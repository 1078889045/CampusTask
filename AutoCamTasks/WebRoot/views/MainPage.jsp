...
This page was saved using <a class="applink" href="http://www.spidersoft.com"><b>WebZIP 7.0.3.1030</b></a> <a class="applink" href="http://www.spidersoft.com"><b>offline browser</b></a>  on  01/02/14 16:18:14.<br>
<b>Address:</b> <a class="info" href="http://task.zhubajie.com/t-logovi/">http://task.zhubajie.com/t-logovi/</a><br>
<b>Title:</b> LOGO/VI设计，LOGO/VI设计最新任务、LOGO/VI设计需求大厅——猪八戒网 &nbsp;&bull;&nbsp; <b>Size:</b> 107391<br></div>
<!-- /Copyright � 2005. Spidersoft Ltd -->
...
<![endif]-->
    ...
    <div class="grid">
        <div class="fr ui-header-nav">
                ...
                <a data-process="1" href="views/register.jsp" class="item-regx">免费注册</a>
                <span class="split">|</span>

                <div class="ui-dropdown">
                <a data-process="1" href="views/Login.jsp" class="ui-dropdown-hd item-login">登录<b></b></a>
                    <ul class="unstyled hezuo-login ui-dropdown-menu">
                        <li><a data-process="1" href="https://login.zhubajie.com/login" class="zhubajie">猪八戒账号登录</a></li>
                        <li><a data-process="1" href="https://login.zhubajie.com/oauth/redirect/act/taobao" class="taob" title="使用淘宝账号登录">淘宝账号登录</a></li>
                        <li><a data-process="1" href="https://login.zhubajie.com/oauth/redirect/act/renren" class="ren" title="使用人人网账号登录">人人网账号登录</a></li>
                        <li><a data-process="1" href="https://login.zhubajie.com/oauth/redirect/act/douban" class="touban" title="使用豆瓣账号登录">豆瓣账号登录</a></li>
                        <li><a data-process="1" href="https://login.zhubajie.com/oauth/redirect/act/sina" class="xinL" title="使用新浪微博账号登录">新浪微博账号登录</a></li>
                        <li><a data-process="1" href="https://login.zhubajie.com/oauth/redirect/act/QQ" class="qq" title="使用QQ账号登录">QQ账号登录</a></li>
                    </ul>
                </div>
                </span>
                <span class="split">|</span>
            ...
            <a target="_blank" data-process="1" href="http://www.zhubajie.com/">猪八戒首页</a>
            <span class="split">|</span>
            <div class="ui-dropdown">
...
<div id="j-vipentry-wrap" style="background: #a71812;height: 60px;">
    ...
    <div class="list-filter">
                ...
                <dt>相关类目:</dt>
                <dd>
                                                                        <a title="LOGO设计" href="http://task.zhubajie.com/t-logovi/logo/">
                                LOGO设计
                            </a>
                                                                                                <a title="VI设计" href="http://task.zhubajie.com/t-logovi/vi/">
                                VI设计
                            </a>
                                                                                                <a title="字体设计" href="http://task.zhubajie.com/t-logovi/ziti/">
                                字体设计
                            </a>
                                                                                                <a title="图标设计" href="http://task.zhubajie.com/t-logovi/tubiao/">
                                图标设计
                            </a>
                                                            </dd>
            </dl>
        ...
        <a href="http://task.zhubajie.com/t-logovi/m1.html" class='selected'>
            全部
        </a>
        ...
        <a href="http://task.zhubajie.com/t-logovi/m2.html" >
            比稿
        </a>
        ...
        <a href="http://task.zhubajie.com/t-logovi/m3.html" >
            招标
        </a>
        ...
        <a href="http://task.zhubajie.com/t-logovi/m4.html" >
            计件
        </a>
    
                <button class="ui-btn ui-btn-mini filter-save-btn j_save_filter" type="button" data-filters="">保存筛选</button>
            </dd>
        </dl>
        <dl>
            <dt>赏<span style="visibility:hidden;">占位</span>金:</dt>
            <dd>
                    
                                                
                            
        <a href="http://task.zhubajie.com/t-logovi/h1.html" class='selected'>
            全部
        </a>
        ...
        <a href="http://task.zhubajie.com/t-logovi/h3.html" >
            已托管赏金
        </a>
        ...
        <a href="http://task.zhubajie.com/t-logovi/h4.html" >
            未托管赏金
        </a>
        ...
        <a href="http://task.zhubajie.com/t-logovi/h2.html" >
            暂未定价
        </a>
        ...
        <a href="http://task.zhubajie.com/t-logovi/t1.html" class='selected'>
            全部
        </a>
        ...
        <a href="http://task.zhubajie.com/t-logovi/t999.html" >
            加急
        </a>
        ...
        <a href="http://task.zhubajie.com/t-logovi/t5.html" >
            今日发布
        </a>
        ...
        <a href="http://task.zhubajie.com/t-logovi/t6.html" >
            昨日发布
        </a>
        ...
        <a href="http://task.zhubajie.com/t-logovi/t2.html" >
            近3天发布
        </a>
        ...
        <a href="http://task.zhubajie.com/t-logovi/t4.html" >
            24小时内到期
        </a>
        ...
        <a href="http://task.zhubajie.com/t-logovi/t7.html" >
            2天内到期
        </a>
        ...
        <a href="http://task.zhubajie.com/t-logovi/t3.html" >
            3天内到期
        </a>
    ...
    <div   class="ui-dropdown task-area-select" data-url="http://task.zhubajie.com/t-logovi/" data-area-pid="" data-area-cid="">
        ...
        <div id="tab-container" class="tab-container">
          <ul class='etabs'>
            <li class='tab'><a href="#tabs1-province" onclick="" class="tab-header-province">请选择</a></li>
            <li class='tab'><a href="#tabs1-city" onclick="" class="tab-header-city">请选择</a></li>
          </ul>
          <div id="tabs1-province" class="area-content provincelist">
            <ul class="unstyled">
                <li><a href="javascript:;">全部</a></li>
                                    <li><a href="javascript:;" onclick=""  data-id="3395">安徽</a></li>
                                    <li><a href="javascript:;" onclick=""  data-id="3460">福建</a></li>
                                    <li><a href="javascript:;" onclick=""  data-id="3476">甘肃</a></li>
                                    <li><a href="javascript:;" onclick=""  data-id="3492">广东</a></li>
                                    <li><a href="javascript:;" onclick=""  data-id="3520">广西</a></li>
                                    <li><a href="javascript:;" onclick=""  data-id="3534">贵州</a></li>
                                    <li><a href="javascript:;" onclick=""  data-id="3546">海南</a></li>
                                    <li><a href="javascript:;" onclick=""  data-id="3569">河北</a></li>
                                    <li><a href="javascript:;" onclick=""  data-id="3585">黑龙江</a></li>
                                    <li><a href="javascript:;" onclick=""  data-id="3601">河南</a></li>
                                    <li><a href="javascript:;" onclick=""  data-id="3626">湖北</a></li>
                                    <li><a href="javascript:;" onclick=""  data-id="3644">湖南</a></li>
                                    <li><a href="javascript:;" onclick=""  data-id="3659">江苏</a></li>
                                    <li><a href="javascript:;" onclick=""  data-id="3686">江西</a></li>
                                    <li><a href="javascript:;" onclick=""  data-id="3700">吉林</a></li>
                                    <li><a href="javascript:;" onclick=""  data-id="3712">辽宁</a></li>
                                    <li><a href="javascript:;" onclick=""  data-id="3729">内蒙古</a></li>
                                    <li><a href="javascript:;" onclick=""  data-id="3742">宁夏</a></li>
                                    <li><a href="javascript:;" onclick=""  data-id="3748">青海</a></li>
                                    <li><a href="javascript:;" onclick=""  data-id="3758">山东</a></li>
                                    <li><a href="javascript:;" onclick=""  data-id="3802">山西</a></li>
                                    <li><a href="javascript:;" onclick=""  data-id="3816">陕西</a></li>
                                    <li><a href="javascript:;" onclick=""  data-id="3828">四川</a></li>
                                    <li><a href="javascript:;" onclick=""  data-id="3896">新疆</a></li>
                                    <li><a href="javascript:;" onclick=""  data-id="3916">西藏</a></li>
                                    <li><a href="javascript:;" onclick=""  data-id="3924">云南</a></li>
                                    <li><a href="javascript:;" onclick=""  data-id="3945">浙江</a></li>
                                    <li><a href="javascript:;" onclick=""  data-id="6564">香港</a></li>
                                    <li><a href="javascript:;" onclick=""  data-id="6563">台湾</a></li>
                                    <li><a href="javascript:;" onclick=""  data-id="6566">澳门</a></li>
                                    <li><a href="javascript:;" onclick=""  data-id="6560">北京</a></li>
                                    <li><a href="javascript:;" onclick=""  data-id="6561">重庆</a></li>
                                    <li><a href="javascript:;" onclick=""  data-id="7275">上海</a></li>
                                    <li><a href="javascript:;" onclick=""  data-id="7276">天津</a></li>
                            </ul>
            <!-- content -->
          </div>
          <div id="tabs1-city" class="area-content citylist">
          </div>
        </div>
        </div>
    </div>
		...
		<table class="list-task">
							        <colgroup>
							        <col><col width="110px"><col width="130px"><col width="105px">
							        </colgroup>	
		<c:if test="${not empty Tasks}">
		<div>
				
				<c:forEach items="${Tasks}" varStatus="status">
					<c:choose>  
					       <c:when test="${Tasks[status.count-1].ifComplete=='0'}">  
					          	
							        <tr>
							        <td><p><em class="list-task-reward">&yen;&nbsp;${Tasks[status.count-1].reward}</em><a
									class="list-task-title" href="SingleServlet?taskId=${Tasks[status.count-1].taskId}">${Tasks[status.count-1].taskContent}</a><a tool-map="top" tool-text="来自LOGO设计专场的需求" class="zbj-tooltip task-
									icons task-icons-logo " href="http://www.zhubajie.com/special/logo"
									target="_blank"></a><a tool-map="top" tool-text="屏蔽搜索引擎 " class="zbj-tooltip task-							
									icons task-icons-spider" href="javascript:return false;"></a><span class='list-icon-top' 				
									act-type="window" act-href="http://task.zhubajie.com/api/paidslisting-do-page.html?
									jsonpcallback=?"></span></p><p class="list-task-ctn"></p></td>
									<td><p><em class="list-task-trusteeship">已托管</em></p>
							        </td>
							        <td><a class="blue" rel="nofollow" href="http://task.zhubajie.com/3580247/#bid-						
									erea" target="_blank" data-zbjlog="{obj:'main'}">32</a><span class="text">参与
									</span><span class="text"> | </span><span class="text">比稿</span>
							        </td>
							        <td><span class="text">${Tasks[status.count-1].stopTime}截止</span>
							        </td>
							        </tr>
        ...
        <div class="list-footer"><div class="list-search-box"><form class="ui-form-minisearch" method="get" action="http://search.zhubajie.com/t/"  title="快速搜索需求"><input type="text" class="search-query list-search-kw" placeholder="快速搜索需求" name="kw"><button type="submit" class="ui-btn ui-btn-link"><i class="iconfont">&#xe809;</i></button></form>
        </div>
...
<ul>
                                    ...
                                    <li class="active"><a href="http://task.zhubajie.com/t-logovi/p1.html" rel="nofollow">1</a></li>
                                                <li ><a href="http://task.zhubajie.com/t-logovi/p2.html" rel="nofollow">2</a></li>
            
                                <li ><a href="http://task.zhubajie.com/t-logovi/p3.html" rel="nofollow">3</a></li>
                                <li ><a href="http://task.zhubajie.com/t-logovi/p4.html" rel="nofollow">4</a></li>
                                <li ><a href="http://task.zhubajie.com/t-logovi/p5.html" rel="nofollow">5</a></li>
                                <li ><a href="http://task.zhubajie.com/t-logovi/p6.html" rel="nofollow">6</a></li>
                                <li ><a href="http://task.zhubajie.com/t-logovi/p7.html" rel="nofollow">7</a></li>
                                <li ><a href="http://task.zhubajie.com/t-logovi/p8.html" rel="nofollow">8</a></li>
                                <li ><a href="http://task.zhubajie.com/t-logovi/p9.html" rel="nofollow">9</a></li>
                                <li ><a href="http://task.zhubajie.com/t-logovi/p10.html" rel="nofollow">10</a></li>
                                <li ><a href="http://task.zhubajie.com/t-logovi/p11.html" rel="nofollow">11</a></li>
                                <li ><a href="http://task.zhubajie.com/t-logovi/p12.html" rel="nofollow">12</a></li>
    
                        <li class="disabled"><a>...</a></li>
            
                                <li ><a href="http://task.zhubajie.com/t-logovi/p100.html" rel="nofollow">100</a></li>
    

                    <li ><a href="http://task.zhubajie.com/t-logovi/p2.html" rel="next">»</a></li>
    
</ul></div><div class="asset-a-d" id="CHANNEL_COMMON"></div></div>    </div>
        ...
        <div class="right-task-list-pub">
            <div class="list-side list-pub">
    <div class="list-side-hd">发布需求,坐等服务商上门</div>
    <div class="list-side-bd">
        <ul class="list-pub-ul unstyled">
            <li class="first">1小时内收到服务商响应</li>
            <li class="second">至少10个服务商参与</li>
            <li class="third">95%的需求得到了圆满解决</li>
        </ul>
        <a class="ui-btn ui-btn-inverse list-pub-btn" href="http://task.zhubajie.com/pub/step1?from_cid=10012" target="_blank">立即发布需求</a>
    </div>
    <div class="list-side-ft">
        <div class="list-pub-news-slide">
            <ul class="list-pub-news unstyled" id="j-list-pub-slide">
                            </ul>
        </div>
        <div class="list-pub-more">
                            <a href="http://task.zhubajie.com/" target="_blank">更多需求></a>
                    </div>
    </div>
</div>        </div>
    
    
        <div class="list-side list-recommend">
            <div class="list-side-hd">
                热点需求
            </div>
            <div class="list-side-bd list-side-task">
                <ul class="list-recommend-ul unstyled">
                                        <li>
                        <div class="recommond-img"><a href="http://task.zhubajie.com/2400561/" target="_blank"><img src="http://p6.zbjimg.com/cms/2013-11/05/cmER37rd2h1129/527852e9a509e.jpg" alt="淘宝网店推广每单4元"/></a></div>
                        <div class="recommond-other-info">
                            <div class="recommond-title"><em>￥ 6000</em><a href="http://task.zhubajie.com/2400561/" target="_blank">淘宝网店推广每单4元</a></div>
                            <div class="recommond-status">
                                <em class="status-4">交易成功</em>
                                <span class="left-time">
                                        ...
                                        <li>
                        <div class="recommond-img"><a href="http://task.zhubajie.com/2716764/" target="_blank"><img src="http://p6.zbjimg.com/cms/2013-12/27/cmER37rd2h1129/52bce0f015d55.jpg" alt="鲜榨果汁店店铺LOGO设计"/></a></div>
                        <div class="recommond-other-info">
                            <div class="recommond-title"><em>￥ 500</em><a href="http://task.zhubajie.com/2716764/" target="_blank">鲜榨果汁店店铺LOGO设计</a></div>
                            <div class="recommond-status">
                                <em class="status-4">交易成功</em>
                                <span class="left-time">
                                        ...
                                        <li>
                        <div class="recommond-img"><a href="http://task.zhubajie.com/3356902/" target="_blank"><img src="http://p6.zbjimg.com/cms/2013-11/07/cmER37rd2h1129/527b0198d0209.jpg" alt="实现搜索功能的插件"/></a></div>
                        <div class="recommond-other-info">
                            <div class="recommond-title"><em>￥ 2000</em><a href="http://task.zhubajie.com/3356902/" target="_blank">实现搜索功能的插件</a></div>
                            <div class="recommond-status">
                                <em class="status-4">交易成功</em>
                                <span class="left-time">
                                        ...
                                        <li>
                        <div class="recommond-img"><a href="http://task.zhubajie.com/3341735/" target="_blank"><img src="http://p6.zbjimg.com/cms/2013-11/05/cmER37rd2h1129/527879561b347.jpg" alt="化妆品公司广告语征集"/></a></div>
                        <div class="recommond-other-info">
                            <div class="recommond-title"><em>￥ 1000</em><a href="http://task.zhubajie.com/3341735/" target="_blank">化妆品公司广告语征集</a></div>
                            <div class="recommond-status">
                                <em class="status-4">交易成功</em>
                                <span class="left-time">
                                        ...
                                        <li>
                        <div class="recommond-img"><a href="http://task.zhubajie.com/2345177/" target="_blank"><img src="http://p6.zbjimg.com/cms/2013-11/05/cmER37rd2h1129/52787db424691.jpg" alt="征集各地方言求婚视频"/></a></div>
                        <div class="recommond-other-info">
                            <div class="recommond-title"><em>￥ 520</em><a href="http://task.zhubajie.com/2345177/" target="_blank">征集各地方言求婚视频</a></div>
                            <div class="recommond-status">
                                <em class="status-4">交易成功</em>
                                <span class="left-time">
                                        ...
                                        <li>
                        <div class="recommond-img"><a href="" target="_blank"><img src="http://p6.zbjimg.com/cms/2013-12/23/cmER37rd2h1129/52b7968cbd988.jpg" alt="烤漆場ＬＯＧＯ設計 已有概念圖（只需組裝）"/></a></div>
                        <div class="recommond-other-info">
                            <div class="recommond-title"><em>$ 1592</em><a href="" target="_blank">烤漆場ＬＯＧＯ設計 已有概念圖（只需組裝）</a></div>
                            <div class="recommond-status">
                                <em class="status-2">投标中</em>
                                <span class="left-time">
                                        ...
                                        <li>
                        <div class="recommond-img"><a href="http://task.zhubajie.com/1513935/" target="_blank"><img src="http://p6.zbjimg.com/cms/2013-11/05/cmER37rd2h1129/527852c0917cb.jpg" alt="网站关键字排名优化"/></a></div>
                        <div class="recommond-other-info">
                            <div class="recommond-title"><em>￥ 1000</em><a href="http://task.zhubajie.com/1513935/" target="_blank">网站关键字排名优化</a></div>
                            <div class="recommond-status">
                                <em class="status-4">交易成功</em>
                                <span class="left-time">
                                        ...
                                        <li>
                        <div class="recommond-img"><a href="http://task.zhubajie.com/3269353/" target="_blank"><img src="http://p6.zbjimg.com/cms/2013-11/05/cmER37rd2h1129/5278bcd17d62f.jpg" alt="百年堂阿胶铁盒包装设计"/></a></div>
                        <div class="recommond-other-info">
                            <div class="recommond-title"><em>￥ 4000</em><a href="http://task.zhubajie.com/3269353/" target="_blank">百年堂阿胶铁盒包装设计</a></div>
                            <div class="recommond-status">
                                <em class="status-4">交易成功</em>
                                <span class="left-time">
                                        ...
                                        <li>
                        <div class="recommond-img"><a href="http://task.zhubajie.com/3380527/" target="_blank"><img src="http://p6.zbjimg.com/cms/2013-11/05/cmER37rd2h1129/5278796d83467.jpg" alt="请大师给宝宝起名字"/></a></div>
                        <div class="recommond-other-info">
                            <div class="recommond-title"><em>￥ 200</em><a href="http://task.zhubajie.com/3380527/" target="_blank">请大师给宝宝起名字</a></div>
                            <div class="recommond-status">
                                <em class="status-4">交易成功</em>
                                <span class="left-time">
                                        ...
                                        <li>
                        <div class="recommond-img"><a href="http://task.zhubajie.com/3333924/" target="_blank"><img src="http://p6.zbjimg.com/cms/2013-11/05/cmER37rd2h1129/52784ed7d20cc.jpg" alt="基于Android的相册应用开发"/></a></div>
                        <div class="recommond-other-info">
                            <div class="recommond-title"><em>￥ 8000</em><a href="http://task.zhubajie.com/3333924/" target="_blank">基于Android的相册应用开发</a></div>
                            <div class="recommond-status">
                                <em class="status-2">投标中</em>
                                <span class="left-time">
    ...
    <div class="list-a-d">
        <a target="_blank" href="http://www.zhubajie.com/witmart/r?l=http://www.witmart.com/cn/jobs/&utm_source=ZBJ_LuPai&utm_medium=XuQiuDaTing&utm_campaign=ZBJ">
            <img src="http://t5.zbjimg.com/t5s/common/img/zbj_provider.png" alt="猪八戒网国际站让您赚美元"/>
        </a>
    </div>
    
        <div class="asset-a-d" id="TASK_L1"></div>
        <div class="asset-a-d" id="TASK_L2"></div>
        <div class="asset-a-d" id="TASK_L3"></div>
        <div class="asset-a-d" id="TASK_L4"></div>
        <div class="asset-a-d" id="TASK_L5"></div>
        <div class="asset-a-d" style='text-align:center;margin:18px auto;' id="TASK_L6">
            <script type="text/javascript">var cpro_id = "u1415756";</script>
    ...
    <div class="grid hot-service">
    <div class="hot-service-hd list-recommend-showhere">
        热门需求
    </div>
    <div class="hot-service-bd list-side-task">
        <ul class="list-recommend-ul unstyled">
                        <li>
                <div class="recommond-img"><a href="http://task.zhubajie.com/874816/" target="_blank"><img src="http://p6.zbjimg.com/cms/2013-11/05/cmER37rd2h1129/52787937398e0.jpg" alt="华剑集团歌词征集"/></a></div>
                <div class="recommond-other-info">
                    <div class="recommond-title"><em>￥5000</em><a href="http://task.zhubajie.com/874816/" target="_blank" title="华剑集团歌词征集">华剑集团歌词征集</a></div>
                    <div class="recommond-status">
                        <em class="status-4">交易成功</em>
                            <span class="left-time">
                        ...
                        <li>
                <div class="recommond-img"><a href="http://task.zhubajie.com/3385801/" target="_blank"><img src="http://p6.zbjimg.com/cms/2013-11/05/cmER37rd2h1129/5278ba23743f1.jpg" alt="20套听力题录制MP3"/></a></div>
                <div class="recommond-other-info">
                    <div class="recommond-title"><em>￥1000</em><a href="http://task.zhubajie.com/3385801/" target="_blank" title="20套听力题录制MP3">20套听力题录制MP3</a></div>
                    <div class="recommond-status">
                        <em class="status-4">交易成功</em>
                            <span class="left-time">
                        ...
                        <li>
                <div class="recommond-img"><a href="" target="_blank"><img src="http://p6.zbjimg.com/cms/2013-12/23/cmER37rd2h1129/52b797385fcbb.jpg" alt="Develop Android APP - 开发安卓系统app"/></a></div>
                <div class="recommond-other-info">
                    <div class="recommond-title"><em>￥2200</em><a href="" target="_blank" title="Develop Android APP - 开发安卓系统app">Develop Android APP - 开发安卓系统app</a></div>
                    <div class="recommond-status">
                        <em class="status-2">投标中</em>
                            <span class="left-time">
                                2天16小时57分
                        ...
                        <li>
                <div class="recommond-img"><a href="http://task.zhubajie.com/712632/" target="_blank"><img src="http://p6.zbjimg.com/cms/2013-11/05/cmER37rd2h1129/5278b9f1817f2.jpg" alt="城市宣传片、形象片拍摄"/></a></div>
                <div class="recommond-other-info">
                    <div class="recommond-title"><em>￥1001</em><a href="http://task.zhubajie.com/712632/" target="_blank" title="城市宣传片、形象片拍摄">城市宣传片、形象片拍摄</a></div>
                    <div class="recommond-status">
                        <em class="status-4">交易成功</em>
                            <span class="left-time">
                        ...
                        <li>
                <div class="recommond-img"><a href="http://task.zhubajie.com/3289286/" target="_blank"><img src="http://p6.zbjimg.com/cms/2013-11/05/cmER37rd2h1129/52787dd1e8a0d.jpg" alt="365份生日照片祝福"/></a></div>
                <div class="recommond-other-info">
                    <div class="recommond-title"><em>￥365</em><a href="http://task.zhubajie.com/3289286/" target="_blank" title="365份生日照片祝福">365份生日照片祝福</a></div>
                    <div class="recommond-status">
                        <em class="status-4">交易成功</em>
                            <span class="left-time">
    ...
    <div class="list-btm-search">
        <div class="ui-header-search ui-footer-search" id="footer-search">
            <form data-process="1" id="j-footer-searchform" action="http://search.zhubajie.com/p/" class="ui-form-search">
                <div class="input-append">
                    <div class="ui-dropdown" id="j-footer-searchwrap">
                        <span class="ui-dropdown-hd"><span id="j-footer-searchlabel">服务商</span><i class="iconfont">&#xe807;</i></span>
                        <ul class="unstyled ui-dropdown-menu" style="display: none;">
                            <li class="hide" data-type="witkey"><a href="javascript:;">服务商</a></li>
                            <li data-type="task"><a href="javascript:;">需&nbsp;&nbsp;&nbsp;求</a></li>
                            <li data-type="service"><a href="javascript:;">服&nbsp;&nbsp;&nbsp;务</a></li>
                        </ul>
                    </div>
                    <input name="kw" id="j-footer-kw" type="text" class="search-query" placeholder="想找什么?输入关键字试试" autocomplete="off" disableautocomplete="">
                    <button type="submit" class="ui-btn ui-btn-inverse"><i class="iconfont">&#xe809;</i></button>
                </div>
            </form>
        </div>
